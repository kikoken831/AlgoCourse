...
public class ExternalChainingHashMap<K, V> {
    ...
    public V put(K key, V value) {
        ...
        this.table[index] = new ExternalChainingMapEntry<K, V>(key, value, this.table[index]);
        this.size++;
        return null;
    }
    ...
    private void resizeBackingTable(int length) {
        // WRITE YOUR CODE HERE (DO NOT MODIFY METHOD HEADER)!
        ExternalChainingMapEntry<K, V>[] oldTable = this.table;
        this.table = (ExternalChainingMapEntry<K, V>[]) new ExternalChainingMapEntry[length];
        this.size = 0;
...
}//54 27 73 null 33 null 88 null null 29 42 null null null 89